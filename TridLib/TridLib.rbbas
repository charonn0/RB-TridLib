...
Protected Module TridLib
	...
	#tag Method, Flags = &h1
		Protected Function GetInfo(InfoType As Integer, InfoIndex As Integer) As Integer
		  ...
		  Return GetInfo(InfoType, InfoIndex, mb)
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h1
		Protected Function SetDefsPack(RawDefData As MemoryBlock) As Integer
		  If TridLib.IsAvailable And DefCount = 0 Then
		    Return TrID_SetDefsPack(RawDefData)
		  End If
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function TrIDTypes(Extends f As FolderItem) As TridLib.FileType()
		  If DefCount = 0 Then Call LoadDefsPack(App.ExecutableFile.Parent)
